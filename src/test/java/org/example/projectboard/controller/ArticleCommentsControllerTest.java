...
class ArticleCommentsControllerTest {
    ...
    public ArticleCommentsControllerTest(
    ...
    void givenArticleCommentInfo_whenRequesting_thenSavesNewArticleComment() throws Exception {
        ...
        willDoNothing().given(articleCommentService).saveArticleComment(any(ArticleCommentsDto.class));
        ...
        then(articleCommentService).should().saveArticleComment(any(ArticleCommentsDto.class));
    }
